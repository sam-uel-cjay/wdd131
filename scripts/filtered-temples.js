...
const temples = [
  ...
  // The extra 3 temples
  {
    ...
    area: 382207,
    imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/salt-lake-temple/salt-lake-temple-1119-thumb.jpg"
  },
  {
...
function renderTemples(filteredTemples) {
  ...
  filteredTemples.forEach((temple) => {
    ...
    card.innerHTML = `
      ...
      <img src="${temple.imageUrl}" alt="Photo of ${temple.templeName} in ${temple.location}" loading="lazy">
    `;
